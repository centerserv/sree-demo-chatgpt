...
def run_demo(X, y, name, best_params):
    ...
    # Run PPP loop (update_trust handles train/test split and tuning)
...
if __name__ == "__main__":
    ...
    diabetes_params = heart_params  # or use separate tuned values
    run_demo(
    ...
    mnist_params = heart_params  # or use separate tuned values
    run_demo(
        mn.data.values,
